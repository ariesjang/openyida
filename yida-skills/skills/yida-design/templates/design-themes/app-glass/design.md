---
name: "{{PROJECT_NAME}}"
description: "流动双列、层叠摘要与留白工作区；雾紫衬底、柔边和低强度漫射阴影。适合服务门户与体验反馈。"
themeId: "app-glass"
tokens:
  application-global:
    appearance:
      surfaces:
        "--pod-app-root-bg-color": "#e5dff2"
        "--pod-app-root-bg-image": "radial-gradient(ellipse at 5% 20%, rgba(159,209,220,.35), transparent 60%), radial-gradient(ellipse at 90% 70%, rgba(179,145,223,.3), transparent 60%)"
        "--pod-page-bg-color": "#e5dff2"
        "--pod-card-bg-color": "#f9f7fd"
        "--pod-table-cell-color": "var(--pod-card-bg-color)"
      navigation:
        "--pod-shell-theme-bg-color": "#EBE5F4"
        "--pod-nav-item-text-color": "#5A4674"
        "--pod-nav-item-text-hover-color": "#45345F"
        "--pod-nav-item-text-selected-color": "#37264F"
        "--pod-nav-menu-bg-hover-color": "#E0D7EE"
        "--pod-nav-menu-bg-selected-color": "#D2C4E3"
        ...
        "--pod-nav-top-main-border-color": "#C8BFD6"
        ...
        "--pod-nav-logo-border": "1px solid #C8BFD6"
        "--pod-nav-logo-border-radius": "20px"
        "--pod-nav-sub-divider-color": "#C8BFD6"
        ...
        "--pod-nav-l-search-border-color": "#C8BFD6"
        "--pod-nav-popup-bg-color": "var(--pod-shell-theme-bg-color)"
        "--pod-nav-popup-border-radius": "20px"
        "--pod-nav-popup-shadow": "0 10px 32px rgba(69,52,95,.12)"
        ...
        "--pod-nav-search-border-color": "#C8BFD6"
        ...
        "--pod-nav-action-border-color": "#C8BFD6"
        "--pod-nav-action-border": "1px solid #C8BFD6"
        ...
        "--pod-nav-menu-item-height": "48px"
        "--pod-nav-menu-item-radius": "24px"
        "--pod-nav-menu-item-border": "1px solid #FFFFFF"
        "--pod-nav-menu-item-hover-border": "1px solid #FFFFFF"
        "--pod-nav-menu-item-selected-border": "1px solid #7C6996"
        "--pod-nav-menu-font-size": "14px"
        "--pod-nav-menu-item-selected-font-weight": "500"
        "--pod-nav-menu-line-height": "20px"
        "--pod-nav-menu-gap": "10px"
        "--pod-shell-lshape-border-radius": "20px"
      native-form:
        "--form-element-medium-corner": "20px"
        "--form-element-medium-height": "48px"
        "--form-element-medium-font-size": "14px"
        "--input-bg-color": "#f9f7fd"
        "--input-border-width": "1px"
        "--input-border-color": "#c8bfd6"
        "--input-hover-border-color": "var(--color-brand1-6)"
        "--input-focus-border-color": "var(--color-brand1-6)"
        "--input-hover-bg-color": "#f9f7fd"
        "--input-focus-bg-color": "#f9f7fd"
        "--pod-form-label-color": "#45345f"
        "--form-top-label-margin-b": "8px"
        "--yida-form-content-bgcolor": "#f9f7fd"
        "--pod-page-content-max-width": "880px"
        "--pod-page-border-radius": "20px"
        "--pod-page-footer-bg-color": "#f9f7fd"
        "--pod-page-footer-border-radius": "20px"
        "--pod-sticky-footer-box-shadow": "0 10px 32px rgba(69,52,95,.12)"
        "--pod-formView-stickyFooter-bg-color": "#e5dff2"
        "--pod-formView-stickyFooter-box-shadow": "none"
        "--pod-formView-stickyFooter-border": "none"
        "--pod-formView-stickyFooter-border-top": "1px solid #c8bfd6"
        ...
        "--pod-field-preview-bg-color": "#f9f7fd"
        "--pod-field-preview-border-radius": "20px"
        "--pod-field-preview-indicator-color": "var(--color-fill1-3)"
        "--pod-field-preview-shadow": "none"
        "--pod-field-preview-text-color": "#45345f"
    ...
    colors:
      ...
      "--color-line1-1": "#c8bfd6"
      "--color-line1-2": "#c8bfd6"
      "--color-fill1-1": "#e5dff2"
      "--color-fill1-2": "#e5dff2"
      "--color-fill1-3": "#c8bfd6"
      "--color-fill1-5": "#f9f7fd"
      "--color-fill1-10": "#262626"
      "--color-text1-5": "#FFFFFF"
      "--color-text1-4": "#45345f"
      "--color-text1-10": "#45345f"
      "--color-text1-3": "#45345f"
      "--color-text1-2": "#858781"
      "--color-text1-1": "#c8bfd6"
    typography:
  ...
  custom-page:
    ...
    "--oyd-surface-shadow": "0 10px 32px rgba(69,52,95,.12)"
applicationStyle:
...
流动双列、层叠摘要与留白工作区；雾紫衬底、柔边和低强度漫射阴影。适合服务门户与体验反馈。
...
流动双列、层叠摘要与留白工作区。雾紫衬底、柔边和低强度漫射阴影。画布消费 --oyd-page-bg，内容消费 --oyd-surface，文字消费 --oyd-ink，边界消费 --oyd-border。内容最大宽度 --oyd-content-width，内距 --oyd-content-padding；宽屏不放大成空白 KPI 卡。

### 2.2 应用导航

雾紫导航以柔圆菜单和漫射弹层呼应玻璃表面，较深紫灰底标出当前项，搜索区域保持同色层次。

菜单轮廓：圆角 24px；普通边框 1px solid #FFFFFF；悬停边框 1px solid #FFFFFF；选中边框 1px solid #7C6996。这些值同时作用于侧栏和顶部菜单；保持各状态边框宽度一致，用线型、颜色和选中标记表达状态。
...
轻透标题面与辅助说明。标题字体消费 --oyd-heading-font 与 --oyd-heading-size，辅助说明按正文层级。主操作与当前任务相邻；不堆造虚假标签、指标或章号。

### 2.4 布局和移动端

桌面业务工作区：流动双列、层叠摘要与留白工作区。短字段建议 6:6，字段间距 28px、章节间距 56px、内容内距 40px；这些是项目起点，必须在每张表单设计中按组件树和字段长度确定。窄屏与半屏抽屉按实际可用宽度重排顶部、左侧、主体、右侧及字段间区域，侧栏组件可移到主体前后或折叠为合适的窄屏结构；长文本、附件和子表通常占整行。不把屏幕断点当 iframe 宽度，不用 fixed 卡片截断自然内容。

### 2.5 自定义页面设计

自定义页面以 流动双列、层叠摘要与留白工作区 组织真实业务内容，以 轻透标题面与辅助说明 建立标题与首屏焦点，并用 雾紫衬底、柔边和低强度漫射阴影 统一页面表面。页面根据 PRD 安排标题与操作区、状态摘要、筛选、主要内容、上下文信息和反馈区；列表、表格、图表、详情抽屉和表单入口只在业务需要时出现。宽度、列数、高度和滚动方式按内容增长确定，移动端按阅读与操作顺序重排。
...
雾紫衬底、柔边和低强度漫射阴影。流动双列、层叠摘要与留白工作区。图表、图片、时间线只为真实内容出现；没有媒体时以排版与章节构图成立，不为“丰富”捏造指标或入口。
