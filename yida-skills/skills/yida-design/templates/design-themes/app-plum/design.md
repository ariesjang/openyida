---
name: "{{PROJECT_NAME}}"
description: "接近三比二的咨询内容与上下文分栏；绛紫细线、柔白表面与舒展阅读。适合咨询、客户服务与调研。"
themeId: "app-plum"
tokens:
  application-global:
    appearance:
      surfaces:
        "--pod-app-root-bg-color": "#f2eef1"
        "--pod-app-root-bg-image": "none"
        "--pod-page-bg-color": "#f2eef1"
        "--pod-card-bg-color": "#fffdfd"
        "--pod-table-cell-color": "var(--pod-card-bg-color)"
      navigation:
        "--pod-shell-theme-bg-color": "#EEE2EB"
        "--pod-nav-item-text-color": "#653A61"
        "--pod-nav-item-text-hover-color": "#492746"
        "--pod-nav-item-text-selected-color": "#FFF9FD"
        "--pod-nav-menu-bg-hover-color": "#DECBDD"
        "--pod-nav-menu-bg-selected-color": "#653A61"
        ...
        "--pod-nav-logo-border": "1px solid #BC9AB7"
        "--pod-nav-logo-border-radius": "10px"
        "--pod-nav-sub-divider-color": "#BC9AB7"
        ...
        "--pod-nav-l-search-border-color": "#BC9AB7"
        "--pod-nav-popup-bg-color": "var(--pod-shell-theme-bg-color)"
        "--pod-nav-popup-border-radius": "10px"
        "--pod-nav-popup-shadow": "0 8px 24px rgba(101,58,97,.10)"
        ...
        "--pod-nav-search-border-color": "#BC9AB7"
        ...
        "--pod-nav-action-border-color": "#BC9AB7"
        "--pod-nav-action-border": "1px solid #BC9AB7"
      ...
      native-form:
        ...
        "--input-bg-color": "#fffdfd"
        "--input-border-width": "1px"
        "--input-border-color": "#d8cad5"
        "--input-hover-border-color": "var(--color-brand1-6)"
        "--input-focus-border-color": "var(--color-brand1-6)"
        "--input-hover-bg-color": "#fffdfd"
        "--input-focus-bg-color": "#fffdfd"
        "--pod-form-label-color": "#685167"
        "--form-top-label-margin-b": "8px"
        "--yida-form-content-bgcolor": "#fffdfd"
        "--pod-page-content-max-width": "1060px"
        "--pod-page-border-radius": "10px"
        "--pod-page-footer-bg-color": "#fffdfd"
        "--pod-page-footer-border-radius": "10px"
        "--pod-sticky-footer-box-shadow": "none"
        "--pod-formView-stickyFooter-bg-color": "#f2eef1"
        "--pod-formView-stickyFooter-box-shadow": "none"
        "--pod-formView-stickyFooter-border": "none"
        "--pod-formView-stickyFooter-border-top": "1px solid #d8cad5"
    ...
    colors:
      ...
      "--color-line1-1": "#d8cad5"
      "--color-line1-2": "#d8cad5"
      "--color-fill1-1": "#f2eef1"
      "--color-fill1-2": "#f2eef1"
      "--color-fill1-3": "#d8cad5"
      "--color-fill1-5": "#fffdfd"
      "--color-fill1-10": "#262626"
      "--color-text1-5": "#FFFFFF"
      "--color-text1-4": "#685167"
      "--color-text1-10": "#685167"
      "--color-text1-3": "#685167"
      "--color-text1-2": "#858781"
      "--color-text1-1": "#d8cad5"
    typography:
  ...
  custom-page:
    ...
    "--oyd-radius": "10px"
    "--oyd-content-width": "1060px"
    "--oyd-content-padding": "44px"
    "--oyd-field-gap": "32px"
    "--oyd-section-gap": "64px"
    "--oyd-heading-font": "Georgia, 'Songti SC', serif"
    "--oyd-heading-size": "44px"
    "--oyd-rule-style": "double"
    "--oyd-layout-columns": "minmax(0, 7fr) minmax(0, 5fr)"
...
接近三比二的咨询内容与上下文分栏。绛紫细线、柔白表面与舒展阅读。画布消费 --oyd-page-bg，内容消费 --oyd-surface，文字消费 --oyd-ink，边界消费 --oyd-border。内容最大宽度 --oyd-content-width，内距 --oyd-content-padding；宽屏不放大成空白 KPI 卡。
...
衬线标题、导语与双线章节。标题字体消费 --oyd-heading-font 与 --oyd-heading-size，辅助说明按正文层级。主操作与当前任务相邻；不堆造虚假标签、指标或章号。

### 2.4 布局和移动端

桌面业务工作区：接近三比二的咨询内容与上下文分栏。短字段建议 7:5，字段间距 32px、章节间距 64px、内容内距 44px；这些是项目起点，必须在每张表单设计中按组件树和字段长度确定。窄屏与半屏抽屉按实际可用宽度重排顶部、左侧、主体、右侧及字段间区域，侧栏组件可移到主体前后或折叠为合适的窄屏结构；长文本、附件和子表通常占整行。不把屏幕断点当 iframe 宽度，不用 fixed 卡片截断自然内容。

### 2.5 自定义页面设计

自定义页面以 接近三比二的咨询内容与上下文分栏 组织真实业务内容，以 衬线标题、导语与双线章节 建立标题与首屏焦点，并用 绛紫细线、柔白表面与舒展阅读 统一页面表面。页面根据 PRD 安排标题与操作区、状态摘要、筛选、主要内容、上下文信息和反馈区；列表、表格、图表、详情抽屉和表单入口只在业务需要时出现。宽度、列数、高度和滚动方式按内容增长确定，移动端按阅读与操作顺序重排。
...
表单支持在顶部、左侧、主体、右侧和字段之间放置分栏、Divider、图片/图形、Tab/切换、按钮组/操作入口、状态区和字段。各组件分别承担导航、操作、视觉焦点、反馈、层级、节奏、装饰或采集作用。普通业务分组和章节分隔使用 Divider，横向字段组合使用 ColumnContainer。form-layout.json 提供 7:5 空字段列，columnGap=32px、rowGap=32px、display=VERTICAL；按任务与容器宽度补充组件并调整布局。不因主题名称自动套 3:9，不重复已有标题，不用空泛文案凑版式。
...
绛紫细线、柔白表面与舒展阅读。接近三比二的咨询内容与上下文分栏。图表、图片、时间线只为真实内容出现；没有媒体时以排版与章节构图成立，不为“丰富”捏造指标或入口。
