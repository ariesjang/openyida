---
name: "{{PROJECT_NAME}}"
description: "窄幅纵向阅读与按日期组织的清单；暖纸面、虚线章节、柔和纸张阴影。适合服务登记、档案与内容策划。"
themeId: "app-paper"
tokens:
  application-global:
    appearance:
      surfaces:
        "--pod-app-root-bg-color": "#e9dfcd"
        "--pod-app-root-bg-image": "repeating-linear-gradient(0deg, transparent 0 31px, rgba(116,83,56,.04) 31px 32px)"
        "--pod-page-bg-color": "#e9dfcd"
        "--pod-card-bg-color": "#fffaf0"
        "--pod-table-cell-color": "var(--pod-card-bg-color)"
      navigation:
        "--pod-shell-theme-bg-color": "#F0E5D1"
        "--pod-nav-item-text-color": "#745338"
        "--pod-nav-item-text-hover-color": "#57391F"
        "--pod-nav-item-text-selected-color": "#51351F"
        "--pod-nav-menu-bg-hover-color": "#E6D6BA"
        "--pod-nav-menu-bg-selected-color": "#DDC5A1"
        ...
        "--pod-nav-top-main-border-color": "#B49A76"
        ...
        "--pod-nav-logo-border": "1px solid #B49A76"
        "--pod-nav-logo-border-radius": "8px"
        "--pod-nav-sub-divider-color": "#B49A76"
        ...
        "--pod-nav-l-search-border-color": "#B49A76"
        "--pod-nav-popup-bg-color": "var(--pod-shell-theme-bg-color)"
        "--pod-nav-popup-border-radius": "8px"
        "--pod-nav-popup-shadow": "0 4px 12px rgba(116,83,56,.10)"
        ...
        "--pod-nav-search-border-color": "#B49A76"
        ...
        "--pod-nav-action-border-color": "#B49A76"
        "--pod-nav-action-border": "1px solid #B49A76"
        ...
        "--pod-nav-menu-item-radius": "12px 3px 12px 3px"
        "--pod-nav-menu-item-border": "1px solid #B49A76"
        "--pod-nav-menu-item-hover-border": "1px solid #745338"
        "--pod-nav-menu-item-selected-border": "1px solid #745338"
      ...
      native-form:
        ...
        "--input-bg-color": "#fffaf0"
        "--input-border-width": "1px"
        "--input-border-color": "#b49a76"
        "--input-hover-border-color": "var(--color-brand1-6)"
        "--input-focus-border-color": "var(--color-brand1-6)"
        "--input-hover-bg-color": "#fffaf0"
        "--input-focus-bg-color": "#fffaf0"
        "--pod-form-label-color": "#745338"
        "--form-top-label-margin-b": "8px"
        "--yida-form-content-bgcolor": "#fffaf0"
        "--pod-page-content-max-width": "690px"
        "--pod-page-border-radius": "8px"
        "--pod-page-footer-bg-color": "#fffaf0"
        "--pod-page-footer-border-radius": "8px"
        "--pod-sticky-footer-box-shadow": "0 4px 12px rgba(116,83,56,.10)"
        "--pod-formView-stickyFooter-bg-color": "#e9dfcd"
        "--pod-formView-stickyFooter-box-shadow": "none"
        "--pod-formView-stickyFooter-border": "none"
        "--pod-formView-stickyFooter-border-top": "1px solid #b49a76"
    ...
    colors:
      ...
      "--color-line1-1": "#b49a76"
      "--color-line1-2": "#b49a76"
      "--color-fill1-1": "#e9dfcd"
      "--color-fill1-2": "#e9dfcd"
      "--color-fill1-3": "#b49a76"
      "--color-fill1-5": "#fffaf0"
      "--color-fill1-10": "#262626"
      "--color-text1-5": "#FFFFFF"
      "--color-text1-4": "#745338"
      "--color-text1-10": "#745338"
      "--color-text1-3": "#745338"
      "--color-text1-2": "#858781"
      "--color-text1-1": "#b49a76"
    typography:
  ...
  custom-page:
    ...
    "--oyd-radius": "8px"
    "--oyd-content-width": "690px"
    "--oyd-content-padding": "42px"
    "--oyd-field-gap": "30px"
    "--oyd-section-gap": "60px"
    "--oyd-heading-font": "Georgia, 'Songti SC', serif"
    "--oyd-heading-size": "44px"
    "--oyd-rule-style": "dashed"
    "--oyd-layout-columns": "minmax(0, 12fr)"
    "--oyd-surface-shadow": "0 4px 12px rgba(116,83,56,.10)"
applicationStyle:
...
窄幅纵向阅读与按日期组织的清单；暖纸面、虚线章节、柔和纸张阴影。适合服务登记、档案与内容策划。
...
窄幅纵向阅读与按日期组织的清单。暖纸面、虚线章节、柔和纸张阴影。画布消费 --oyd-page-bg，内容消费 --oyd-surface，文字消费 --oyd-ink，边界消费 --oyd-border。内容最大宽度 --oyd-content-width，内距 --oyd-content-padding；宽屏不放大成空白 KPI 卡。

### 2.2 应用导航

奶油色导航如纸页目录，暖棕文字、不对称圆角题签和舒展间距呼应手账表单，当前入口采用较深的暖纸底。

菜单轮廓：圆角 12px 3px 12px 3px；普通边框 1px solid #B49A76；悬停边框 1px solid #745338；选中边框 1px solid #745338。这些值同时作用于侧栏和顶部菜单；保持各状态边框宽度一致，用线型、颜色和选中标记表达状态。
...
纸页顶部题签与短说明。标题字体消费 --oyd-heading-font 与 --oyd-heading-size，辅助说明按正文层级。主操作与当前任务相邻；不堆造虚假标签、指标或章号。

### 2.4 布局和移动端

桌面业务工作区：窄幅纵向阅读与按日期组织的清单。短字段建议 12，字段间距 30px、章节间距 60px、内容内距 42px；这些是项目起点，必须在每张表单设计中按组件树和字段长度确定。窄屏与半屏抽屉按实际可用宽度重排顶部、左侧、主体、右侧及字段间区域，侧栏组件可移到主体前后或折叠为合适的窄屏结构；长文本、附件和子表通常占整行。不把屏幕断点当 iframe 宽度，不用 fixed 卡片截断自然内容。

### 2.5 自定义页面设计

自定义页面以 窄幅纵向阅读与按日期组织的清单 组织真实业务内容，以 纸页顶部题签与短说明 建立标题与首屏焦点，并用 暖纸面、虚线章节、柔和纸张阴影 统一页面表面。页面根据 PRD 安排标题与操作区、状态摘要、筛选、主要内容、上下文信息和反馈区；列表、表格、图表、详情抽屉和表单入口只在业务需要时出现。宽度、列数、高度和滚动方式按内容增长确定，移动端按阅读与操作顺序重排。
...
表单支持在顶部、左侧、主体、右侧和字段之间放置分栏、Divider、图片/图形、Tab/切换、按钮组/操作入口、状态区和字段。各组件分别承担导航、操作、视觉焦点、反馈、层级、节奏、装饰或采集作用。普通业务分组和章节分隔使用 Divider，横向字段组合使用 ColumnContainer。form-layout.json 提供 12 空字段列，columnGap=30px、rowGap=30px、display=VERTICAL；按任务与容器宽度补充组件并调整布局。不因主题名称自动套 3:9，不重复已有标题，不用空泛文案凑版式。
...
暖纸面、虚线章节、柔和纸张阴影。窄幅纵向阅读与按日期组织的清单。图表、图片、时间线只为真实内容出现；没有媒体时以排版与章节构图成立，不为“丰富”捏造指标或入口。
