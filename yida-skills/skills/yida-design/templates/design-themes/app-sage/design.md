  ...
  application-global:
    appearance:
      ...
      navigation:
        ...
        "--pod-nav-top-main-border-color": "#A6BCA9"
        ...
        "--pod-nav-logo-border": "1px solid #A6BCA9"
        "--pod-nav-logo-border-radius": "16px"
        ...
        "--pod-nav-l-search-border-color": "#A6BCA9"
        "--pod-nav-popup-bg-color": "var(--pod-shell-theme-bg-color)"
        "--pod-nav-popup-border-radius": "16px"
        "--pod-nav-popup-shadow": "inset 0 1px 2px rgba(52,91,73,.10)"
        ...
        "--pod-nav-search-border-color": "#A6BCA9"
        ...
        "--pod-nav-action-border-color": "#A6BCA9"
        "--pod-nav-action-border": "1px solid #A6BCA9"
...
柔绿导航与植物表面连贯，圆润菜单与宽松行距延续表单控件，选中底如低矮浮雕，深绿文字保持清晰。

菜单轮廓：圆角 16px；普通边框 none；悬停边框 none；选中边框 none。这些值同时作用于侧栏和顶部菜单；保持各状态边框宽度一致，用线型、颜色和选中标记表达状态。
