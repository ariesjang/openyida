---
name: "{{PROJECT_NAME}}"
description: "四分之一介绍栏与四分之三主工作区；墨绿黑表面、金色细节与长横线。适合明确要求暗色的战略与高管事项。"
themeId: "app-executive"
tokens:
  application-global:
    appearance:
      surfaces:
        "--pod-app-root-bg-color": "#151919"
        "--pod-app-root-bg-image": "linear-gradient(120deg, rgba(217,196,154,.04), transparent 65%)"
        "--pod-page-bg-color": "#151919"
        "--pod-card-bg-color": "#222826"
        "--pod-table-cell-color": "var(--pod-card-bg-color)"
      navigation:
        "--pod-shell-theme-bg-color": "#141C19"
        "--pod-nav-item-text-color": "#C0B494"
        "--pod-nav-item-text-hover-color": "#E7D8B7"
        "--pod-nav-item-text-selected-color": "#181D18"
        "--pod-nav-menu-bg-hover-color": "#2D342C"
        "--pod-nav-menu-bg-selected-color": "#D9C49A"
        ...
        "--pod-nav-top-main-border-color": "#596054"
        ...
        "--pod-nav-logo-border": "1px solid #596054"
        "--pod-nav-logo-border-radius": "4px"
        "--pod-nav-sub-divider-color": "#596054"
        ...
        "--pod-nav-l-search-border-color": "#596054"
        ...
        "--pod-nav-search-border-color": "#596054"
        ...
        "--pod-nav-action-border-color": "#596054"
        "--pod-nav-action-border": "1px solid #596054"
        ...
        "--pod-nav-menu-item-hover-border": "1px solid #C0B494"
        "--pod-nav-menu-item-selected-border": "1px solid #E7D8B7"
      ...
      native-form:
        ...
        "--form-element-medium-height": "42px"
        "--form-element-medium-font-size": "14px"
        "--input-bg-color": "#222826"
        "--input-border-width": "1px"
        "--input-border-color": "#596054"
        "--input-hover-border-color": "var(--color-brand1-6)"
        "--input-focus-border-color": "var(--color-brand1-6)"
        "--input-hover-bg-color": "#222826"
        "--input-focus-bg-color": "#222826"
        "--pod-form-label-color": "#d9c49a"
        "--form-top-label-margin-b": "8px"
        "--yida-form-content-bgcolor": "#222826"
        "--pod-page-content-max-width": "1080px"
        "--pod-page-border-radius": "4px"
        "--pod-page-footer-bg-color": "#222826"
        "--pod-page-footer-border-radius": "4px"
        "--pod-sticky-footer-box-shadow": "none"
        "--pod-formView-stickyFooter-bg-color": "#151919"
        "--pod-formView-stickyFooter-box-shadow": "none"
        "--pod-formView-stickyFooter-border": "none"
        "--pod-formView-stickyFooter-border-top": "1px solid #596054"
    ...
    colors:
      ...
      "--color-line1-1": "#596054"
      "--color-line1-2": "#596054"
      "--color-fill1-1": "#151919"
      "--color-fill1-2": "#151919"
      "--color-fill1-3": "#596054"
      "--color-fill1-5": "#222826"
      "--color-fill1-10": "#262626"
      "--color-text1-5": "#FFFFFF"
      "--color-text1-4": "#d9c49a"
      "--color-text1-10": "#d9c49a"
      "--color-text1-3": "#d9c49a"
      "--color-text1-2": "#7f8986"
      "--color-text1-1": "#596054"
    typography:
...
四分之一介绍栏与四分之三主工作区；墨绿黑表面、金色细节与长横线。适合明确要求暗色的战略与高管事项。
...
四分之一介绍栏与四分之三主工作区。墨绿黑表面、金色细节与长横线。画布消费 --oyd-page-bg，内容消费 --oyd-surface，文字消费 --oyd-ink，边界消费 --oyd-border。内容最大宽度 --oyd-content-width，内距 --oyd-content-padding；宽屏不放大成空白 KPI 卡。

### 2.2 应用导航

墨绿黑导航以香槟金文字和长分隔线组织入口，低圆角菜单延续行政表单，当前项使用金底深字。

菜单轮廓：圆角 4px；普通边框 1px solid transparent；悬停边框 1px solid #C0B494；选中边框 1px solid #E7D8B7。这些值同时作用于侧栏和顶部菜单；保持各状态边框宽度一致，用线型、颜色和选中标记表达状态。
...
左侧香槟金衬线标题与用途说明，右侧单列章节。标题字体消费 --oyd-heading-font 与 --oyd-heading-size，辅助说明按正文层级。主操作与当前任务相邻；不堆造虚假标签、指标或章号。

### 2.4 布局和移动端

桌面业务工作区：四分之一介绍栏与四分之三主工作区。短字段建议 12，字段间距 30px、章节间距 60px、内容内距 40px；这些是项目起点，必须在每张表单设计中按组件树和字段长度确定。窄屏与半屏抽屉按实际可用宽度重排顶部、左侧、主体、右侧及字段间区域，侧栏组件可移到主体前后或折叠为合适的窄屏结构；长文本、附件和子表通常占整行。不把屏幕断点当 iframe 宽度，不用 fixed 卡片截断自然内容。

### 2.5 自定义页面设计

自定义页面以 四分之一介绍栏与四分之三主工作区 组织真实业务内容，以 左侧香槟金衬线标题与用途说明，右侧单列章节 建立标题与首屏焦点，并用 墨绿黑表面、金色细节与长横线 统一页面表面。页面根据 PRD 安排标题与操作区、状态摘要、筛选、主要内容、上下文信息和反馈区；列表、表格、图表、详情抽屉和表单入口只在业务需要时出现。宽度、列数、高度和滚动方式按内容增长确定，移动端按阅读与操作顺序重排。
...
墨绿黑表面、金色细节与长横线。四分之一介绍栏与四分之三主工作区。图表、图片、时间线只为真实内容出现；没有媒体时以排版与章节构图成立，不为“丰富”捏造指标或入口。
