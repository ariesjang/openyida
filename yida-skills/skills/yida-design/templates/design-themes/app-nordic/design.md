---
name: "{{PROJECT_NAME}}"
description: "单列阅读与低密度任务清单；云白表面、柔圆角与大段间距。适合员工服务与预约申请。"
themeId: "app-nordic"
tokens:
  application-global:
    appearance:
      surfaces:
        "--pod-app-root-bg-color": "#f2f5f3"
        "--pod-app-root-bg-image": "none"
        "--pod-page-bg-color": "#f2f5f3"
        "--pod-card-bg-color": "#ffffff"
        "--pod-table-cell-color": "var(--pod-card-bg-color)"
      navigation:
        "--pod-shell-theme-bg-color": "#E4EEE6"
        "--pod-nav-item-text-color": "#526361"
        "--pod-nav-item-text-hover-color": "#354C47"
        "--pod-nav-item-text-selected-color": "#FFFFFF"
        "--pod-nav-menu-bg-hover-color": "#D2E4D8"
        "--pod-nav-menu-bg-selected-color": "#355D4D"
        "--pod-nav-menu-item-selected-shadow": "0 5px 12px rgba(42,74,60,.16)"
        ...
        "--pod-nav-top-main-border-color": "#CDDCCF"
        ...
        "--pod-nav-logo-border": "1px solid #CDDCCF"
        "--pod-nav-logo-border-radius": "999px"
        "--pod-nav-sub-divider-color": "#CDDCCF"
        ...
        "--pod-nav-l-search-border-color": "#CDDCCF"
        "--pod-nav-popup-bg-color": "var(--pod-shell-theme-bg-color)"
        "--pod-nav-popup-border-radius": "14px"
        "--pod-nav-popup-shadow": "0 8px 24px rgba(53,76,71,.08)"
        ...
        "--pod-nav-search-border-color": "#CDDCCF"
        ...
        "--pod-nav-action-border-color": "#CDDCCF"
        "--pod-nav-action-border": "1px solid #CDDCCF"
        ...
        "--pod-nav-menu-item-height": "52px"
        "--pod-nav-menu-item-radius": "999px"
        "--pod-nav-menu-item-border": "2px solid transparent"
        "--pod-nav-menu-item-hover-border": "2px solid #8AA996"
        "--pod-nav-menu-item-selected-border": "2px solid #355D4D"
        "--pod-nav-menu-font-size": "15px"
        "--pod-nav-menu-item-selected-font-weight": "500"
        "--pod-nav-menu-line-height": "20px"
        "--pod-nav-menu-gap": "14px"
        "--pod-shell-lshape-border-radius": "24px"
        "--pod-nav-menu-item-padding": "12px 18px"
        "--pod-nav-slide-aside-gap": "20px"
        "--pod-nav-slide-aside-padding": "16px 14px"
      native-form:
        "--form-element-medium-corner": "14px"
        "--form-element-medium-height": "46px"
        "--form-element-medium-font-size": "14px"
        "--input-bg-color": "#ffffff"
        "--input-border-width": "1px"
        "--input-border-color": "#dce4df"
        ...
        "--pod-form-label-color": "#526361"
        "--form-top-label-margin-b": "8px"
        "--yida-form-content-bgcolor": "#ffffff"
        "--pod-page-content-max-width": "720px"
        "--pod-page-border-radius": "14px"
        "--pod-page-footer-bg-color": "#ffffff"
        "--pod-page-footer-border-radius": "14px"
        "--pod-sticky-footer-box-shadow": "none"
        "--pod-formView-stickyFooter-bg-color": "#f2f5f3"
        "--pod-formView-stickyFooter-box-shadow": "none"
        "--pod-formView-stickyFooter-border": "none"
        "--pod-formView-stickyFooter-border-top": "1px solid #dce4df"
    ...
    colors:
      ...
      "--color-line1-1": "#dce4df"
      "--color-line1-2": "#dce4df"
      "--color-fill1-1": "#f2f5f3"
      "--color-fill1-2": "#f2f5f3"
      "--color-fill1-3": "#dce4df"
      "--color-fill1-5": "#ffffff"
      "--color-fill1-10": "#262626"
      "--color-text1-5": "#FFFFFF"
      "--color-text1-4": "#526361"
      "--color-text1-10": "#526361"
      "--color-text1-3": "#526361"
      "--color-text1-2": "#858781"
      "--color-text1-1": "#dce4df"
    typography:
  ...
  custom-page:
    ...
    "--oyd-radius": "14px"
    "--oyd-content-width": "720px"
    "--oyd-content-padding": "52px"
    "--oyd-field-gap": "36px"
    "--oyd-section-gap": "72px"
...
单列阅读与低密度任务清单；云白表面、柔圆角与大段间距。适合员工服务与预约申请。
...
单列阅读与低密度任务清单。云白表面、柔圆角与大段间距。画布消费 --oyd-page-bg，内容消费 --oyd-surface，文字消费 --oyd-ink，边界消费 --oyd-border。内容最大宽度 --oyd-content-width，内距 --oyd-content-padding；宽屏不放大成空白 KPI 卡。

### 2.2 应用导航

柔绿导航使用宽松胶囊菜单，透明边框预留位置，悬停浅绿描边，选中项深绿底白字配轻阴影；圆润品牌区与单列服务表单保持舒展节奏。
...
导航示例：左侧导航采用柔绿底和 52px 高的宽松胶囊；选中项深绿底白字、2px 深绿边框，悬停浅绿边框，普通项保留透明边界。菜单间距 14px、内距 12px 18px。 实际导航布局沿用业务规划。
...
简短自然标题与舒展说明。标题字体消费 --oyd-heading-font 与 --oyd-heading-size，辅助说明按正文层级。主操作与当前任务相邻；不堆造虚假标签、指标或章号。

### 2.4 布局和移动端

桌面业务工作区：单列阅读与低密度任务清单。短字段建议 12，字段间距 36px、章节间距 72px、内容内距 52px；这些是项目起点，必须在每张表单设计中按组件树和字段长度确定。窄屏与半屏抽屉按实际可用宽度重排顶部、左侧、主体、右侧及字段间区域，侧栏组件可移到主体前后或折叠为合适的窄屏结构；长文本、附件和子表通常占整行。不把屏幕断点当 iframe 宽度，不用 fixed 卡片截断自然内容。

### 2.5 自定义页面设计

自定义页面以 单列阅读与低密度任务清单 组织真实业务内容，以 简短自然标题与舒展说明 建立标题与首屏焦点，并用 云白表面、柔圆角与大段间距 统一页面表面。页面根据 PRD 安排标题与操作区、状态摘要、筛选、主要内容、上下文信息和反馈区；列表、表格、图表、详情抽屉和表单入口只在业务需要时出现。宽度、列数、高度和滚动方式按内容增长确定，移动端按阅读与操作顺序重排。
...
单行控件 46px、圆角 14px，边框 1px；字段 labelAlign=top（标签在字段上方）。多行文本、附件、日期范围、子表按自身布局。详情页沿用相同章节顺序与表面；只读字段的数据框使用 --pod-field-preview-bg-color、--pod-field-preview-border-radius、--pod-field-preview-shadow、--pod-field-preview-indicator-color、--pod-field-preview-text-color、--form-element-medium-font-size、--pod-field-preview-gap、--pod-field-preview-line-height、--pod-field-preview-min-height 和 --pod-field-preview-padding，延续应用的色彩、形状、字体与密度。表格保持紧凑，按钮、输入、浮层和导航消费同源色彩与形状。

### 表单组件与版式结构

表单支持在顶部、左侧、主体、右侧和字段之间放置分栏、Divider、图片/图形、Tab/切换、按钮组/操作入口、状态区和字段。各组件分别承担导航、操作、视觉焦点、反馈、层级、节奏、装饰或采集作用。普通业务分组和章节分隔使用 Divider，横向字段组合使用 ColumnContainer。form-layout.json 提供 12 空字段列，columnGap=36px、rowGap=36px、display=VERTICAL；按任务与容器宽度补充组件并调整布局。不因主题名称自动套 3:9，不重复已有标题，不用空泛文案凑版式。
...
云白表面、柔圆角与大段间距。单列阅读与低密度任务清单。图表、图片、时间线只为真实内容出现；没有媒体时以排版与章节构图成立，不为“丰富”捏造指标或入口。
