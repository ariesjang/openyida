...
function getVisualDecisionPolicy() {
  return {
    ...
    nativeFormLayout: {
      source: 'business_task_content_and_actual_container_width',
      introduction: 'optional_not_implied_by_theme',
      sidebar: 'requires_independent_continuously_useful_content_and_sufficient_width',
      avoid: ['duplicate_dialog_or_section_titles', 'generic_filler_copy', 'random_layout_rotation'],
    },
