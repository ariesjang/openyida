...
const CANVAS_NAV_CSS = `
  ...
  .oy-canvas-nav .oy-nav-item {
    ...
    border: var(--pod-nav-menu-item-border, none); border-radius: var(--pod-nav-menu-item-radius, 8px); background: transparent;
  ...
  .oy-canvas-nav .oy-nav-item:hover:not(:disabled) { border: var(--pod-nav-menu-item-hover-border, var(--pod-nav-menu-item-border, none)); background: var(--pod-nav-menu-bg-hover-color, var(--color-fill1-2, #f2f3f5)); color: var(--pod-nav-item-text-hover-color, inherit); }
  .oy-canvas-nav .oy-nav-item[aria-current="page"], .oy-canvas-nav .oy-nav-item[aria-current="page"]:hover { border: var(--pod-nav-menu-item-selected-border, var(--pod-nav-menu-item-border, none)); box-shadow: var(--pod-nav-menu-item-selected-shadow, none); background: var(--pod-nav-menu-bg-selected-color, var(--color-brand1-1, #e8f2ff)); color: var(--pod-nav-item-text-selected-color, var(--color-brand1-6, #1677ff)); font-weight: var(--pod-nav-menu-item-selected-font-weight, 600); }
