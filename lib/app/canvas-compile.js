...
const { assertCanvasIconExports } = require('./canvas-icon-guard');
const { assertCanvasNavigationStructure } = require('./canvas-navigation-guard');
const { assertCanvasNavigationPaths } = require('./canvas-path-guard');
...
function compileCanvasLocal(source, options = {}) {
  ...
  assertCanvasIconExports(source, options);
  assertCanvasNavigationStructure(source, options);
  assertCanvasNavigationPaths(source, options);
