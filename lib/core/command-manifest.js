    ...
    commands: [
      ...
      command('update-app', ['update-app'], 'update-app <appType> [--name "..."] [--desc "..."] [--icon <name>] [--icon-color <color>] [--colour <key>] [--theme-color <color>] [--theme-file <css>] [--nav-theme light|dark|white|gray] [--logo-source appIcon|customImage] [--layout side|top|l_shape] [--hide-app-nav|--show-app-nav]', 'help.cmd_update_app', {
        args: [
          ...
          { name: 'themeFile', type: 'file', source: 'option', builder_options: ['--theme-file', '--custom-theme-file'], description: 'Application theme CSS generated from base and project tokens; declares --color-brand1-6 and sets colour=custom.' },
  ...
  },
  {
    ...
    commands: [
      ...
      command('sample', ['sample'], 'sample [--list] [<skill> <name>] [--output <file-or-directory>] [--var KEY=VALUE ...] [--design-file <design.md>] [--style-id <themeId|free-creative>]', 'help.cmd_sample', {
        requiresLogin: false,
        notes: [
          'yida-design app-theme applies menu radius, normal/hover/selected borders and selected shadow to side, L-shaped and top navigation. Updating older theme CSS adds the shared menu-shape rules while preserving project CSS.',
        ...
        args: [
          ...
          { name: 'styleId', type: 'string', source: 'option', builder_options: ['--style-id'], description: 'For yida-design application-style: export paired design.md, app_theme.css and native form-layout.json to --output directory. Includes independent free-creative authoring.' },
        ],
      }),
