    ...
    commands: [
      ...
      command('sample', ['sample'], 'sample [--list] [<skill> <name>] [--output <file-or-directory>] [--var KEY=VALUE ...] [--design-file <design.md>] [--style-id <themeId|free-creative>]', 'help.cmd_sample', {
        ...
        notes: [
          ...
          'Application-style form-layout.json contains empty business-field columns, with no preset introduction rail or placeholder headings. Choose no introduction, a top note, local guidance, steps or a sidebar from the task and actual container width. A sidebar needs independent, continuously useful content; do not repeat dialog or section titles.',
