  ...
  },
  {
    ...
    commands: [
      ...
      command('sample', ['sample'], 'sample [--list] [<skill> <name>] [--output <file-or-directory>] [--var KEY=VALUE ...] [--design-file <design.md>] [--style-id <themeId|free-creative>]', 'help.cmd_sample', {
        requiresLogin: false,
        notes: [
          'yida-design application-style --style-id exports a design/CSS/native-layout authoring bundle to an output directory without overwriting files. Use design-plan catalog for presets and its separate creativeOption; free creative requires independent business decisions and explicit design tokens.',
