...
module.exports = {
  ...
  design_document: {
    ...
    anchor_hint: 'An anchor must be written in the body as a self-closing HTML tag, e.g. <a id="component-button"></a> (the tag id has no leading #; the frontmatter reference is #component-button). Markdown heading ids, links like [text](#id), or plain text do not count as anchors.',
...
`,
    ...
    compile_usage: 'Usage: openyida compile <sourceFile> [--canvas] [--compat] [--skip-lint] [--json]',
  ...
  publish: {
    ...
    canvas_theme_fixed_brand_allowed: 'Line {0}: ConfigProvider hardcodes a brand interaction color ({1}); allowed for now because --allow-fixed-brand / OPENYIDA_CANVAS_ALLOW_FIXED_BRAND is set. Migrate to canvas-theme (resolved application colors) soon; this bypass will be removed in a later release.',
    ...
    fix_theme_detected: 'Found {0} hardcoded brand interaction color override(s) that can be auto-migrated: remove the hardcoded overrides and let the application theme resolve them.',
    fix_theme_item: '  · Line {0} {1}: {2}',
    fix_theme_confirm: 'Auto-migrate the theme now? This rewrites your source file (removes the hardcoded brand-color overrides). [y/N]',
    fix_theme_applied: 'Theme migration applied and written back to source: {0}',
    fix_theme_skipped: 'Skipped theme migration; source left unchanged. Migrate to canvas-theme manually, or pass --allow-fixed-brand to bypass temporarily.',
    fix_theme_flag_hint: 'Non-interactive environment: no auto-migration. Re-run with --fix-theme to rewrite the source automatically.',
    ...
    usage: 'Usage: openyida publish <sourceFile> <appType> <formUuid> [--health-check] [--force] [--canvas] [--compat] [--skip-lint] [--fix-theme] [--strict-theme] [--auto-nav-order] [--open|--no-open] [--json]',
...
module.exports.sample_options = {
  ...
  'style_help': 'application-style: --style-id is required and accepts every catalog theme; --output is a directory for three files. Existing bundle files cause an error.'
};
