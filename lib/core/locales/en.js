...
module.exports = {
  ...
  help: {
    ...
    cmd_design_plan_materialize: 'Generate and validate design-plan artifacts from build-plan.json',
    cmd_design_plan_patch: 'Patch a design plan; asset progress preserves existing approval',
