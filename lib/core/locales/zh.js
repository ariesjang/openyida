...
`,
  ...
  publish: {
    ...
    canvas_theme_fixed_brand: '第 {0} 行的 ConfigProvider 将品牌交互色固定为字符串。请提取 canvas-theme，使用应用主题解析值；CSS var 仅直接用于 DOM 样式，不能替代 antd 色值解析。',
    ...
    usage: '用法: openyida publish <源文件路径> <appType> <formUuid> [--health-check] [--force] [--canvas] [--compat] [--skip-lint] [--auto-nav-order] [--open|--no-open] [--json]',
