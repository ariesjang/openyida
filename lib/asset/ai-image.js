...
function getMaterialSourcingGuidance() {
  return {
    steps: [
      '1. Plan 确认后、Fast 设计就绪后启动后台素材任务，记录宿主任务编号，立即继续创建应用、表单和页面；有图页面先做布局、文字、数据绑定和交互。',
    ...
    schedulingPolicy: {
      ...
      dispatchMode: 'host_background_task',
      ...
      unsupportedHost: 'batch_calls_then_continue_independent_work',
