...
module.exports = {
  ...
  create_page: {
    ...
    usage: 'Utilisation : openyida create-page <appType> <nom de la page> [--mode dashboard] [--hide-nav]',
  ...
  publish: {
    ...
    usage: 'Utilisation : openyida publish <fichierSource> <appType> <formUuid> [--health-check] [--canvas] [--auto-nav-order]',
