...
module.exports = {
  ...
  common: {
    ...
    code_bundle_download_failed: 'CodeBundle-Download fehlgeschlagen: {0} ({1})',
    code_bundle_forbidden: 'Berechtigungsprüfung oder OSS-Zugriff wurde verweigert',
    code_bundle_not_found: 'Die Datei ist nicht vorhanden oder wurde entfernt',
    code_bundle_http_error: 'HTTP {0}',
    code_bundle_html_response: 'Eine HTML-Fehlerseite wurde empfangen; Umgebung oder Route könnte falsch sein',
    code_bundle_json_response: 'Der Dienst hat eine JSON-Fehlerantwort zurückgegeben: {0}',
    code_bundle_unexpected_content_type: 'Unerwarteter Content-Type der Antwort: {0}',
    code_bundle_invalid_utf8: 'Die Antwort ist kein gültiger UTF-8-Text',
    code_bundle_integrity_failed: 'Integritätsprüfung für CodeBundle {0} fehlgeschlagen ({1})',
  ...
  save_permission: {
    package_uuid_create_conflict: '--package-uuid kann nicht mit --create verwendet werden',
    package_uuid_not_found: 'Keine Berechtigungsgruppe mit packageUuid={0}; ohne Schreibvorgang abgebrochen',
    before_unknown: 'Der vollständige Zustand vor dem Schreiben konnte nicht gelesen werden; abgebrochen: {0}',
    verify_failed: 'Die exakte Rücklesung nach dem Schreiben weicht ab (packageUuid={0})',
    verify_unknown: 'Das Ergebnis des Schreibvorgangs ist unbekannt (packageUuid={0}); vor einem neuen Versuch exakt abfragen',
  },
  get_page_config: {
  ...
  save_share_config: {
    ...
    open_auth_hint: '  openAuth: y=Auth erforderlich, n=keine Auth; weglassen, um die vollständige Konfiguration zu erhalten',
    ...
    open_auth_preserve: 'aktuellen Wert beibehalten',
  ...
  configure_process: {
    replace_required: 'Ein veröffentlichter Prozess oder gespeicherter Entwurf ist vorhanden. Ein vollständiger Ersatz erfordert ausdrücklich --replace; es wurde nicht remote geschrieben.',
    ownership_unverified: 'Die Zugehörigkeit des processCode zu diesem Formular konnte nicht belegt werden. Es wurde nicht remote geschrieben.',
    published_unverified: 'Die Veröffentlichung war erfolgreich, aber die exakte PUBLISHED-Plattformansicht konnte nicht vollständig verifiziert werden. Lesen Sie den Zustand vor einem erneuten Versuch zurück.',
  },
  ...
  publish: {
    ...
    fix_theme_skipped: 'Themenmigration übersprungen; Quelle unverändert. Migrieren Sie manuell zu canvas-theme oder verwenden Sie --allow-fixed-brand zum vorübergehenden Umgehen.',
    fix_theme_flag_hint: 'Nicht-interaktive Umgebung: keine automatische Migration. Führen Sie den Befehl erneut mit --fix-theme aus, um die Quelle automatisch zu überschreiben.',
    ...
    step_canvas_compile: '\n📦 Step 1: Quelle der benutzerdefinierten Seite kompilieren\n',
